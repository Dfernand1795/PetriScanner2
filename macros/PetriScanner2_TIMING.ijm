...
///////////////////////////////////////    Segmentation    ///////////////////////////////////////////////////////////////
            ...
            close("Last_Frame");
            //3.6) Create the labels for colonie - Ids that will be used in the future. 
            ...
            //4)Measuring colonie morphology and color.
            run("Set Scale...", "distance="+DPI+" known=25.4 unit=mm global");  //4.1) Setting approppiate DPI scale:
        ...
        if (isOpen("Log")){
            selectWindow("Log");
            saveAs("Text", path+"/Raw_csv_results/"+Dish+"/Log_timing"+iter+".txt");  
            close("Log");
        }
        close("Results");
        close("ROI Manager");
